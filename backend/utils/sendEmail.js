...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'mahalalakshmisidda50@gmail.com',
    pass: 'cmmcffwfzwnbgvtc',
  },
});
...
const sendOrderConfirmation = async (order, userEmail, userName) => {
  ...
  await transporter.sendMail({
    from: '"MAISON Fashion" <mahalalakshmisidda50@gmail.com>',
    to: userEmail,
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f7f4ef">
        ...
        <div style="background:#0f0e0d;padding:25px;text-align:center">
          ...
          <p style="color:#6a6560;font-size:12px;margin:8px 0 0">Questions? Email us at mahalalakshmisidda50@gmail.com</p>
        </div>
      </div>
    `,
  });
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f7f4ef">
        ...
        <div style="padding:40px 30px;background:#ffffff">
          ...
          <div style="text-align:center;margin-top:30px">
            <p style="color:#7a7570;font-size:14px">Enjoyed your purchase? Shop more at MAISON!</p>
            <a href="http://localhost:3000/products" style="background:#b5833a;color:#ffffff;padding:14px 32px;text-decoration:none;font-size:13px;letter-spacing:0.12em;text-transform:uppercase;display:inline-block;margin-top:10px">
              Shop Again
            </a>
          </div>
        </div>
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
        ...
        <div style="padding:40px 30px;background:#ffffff">
          ...
          <div style="text-align:center;margin:30px 0">
            <a href="http://localhost:3000/products" style="background:#b5833a;color:#ffffff;padding:14px 32px;text-decoration:none;font-size:13px;letter-spacing:0.12em;text-transform:uppercase">
              Shop Now
            </a>
          </div>
        </div>
...
const sendAdminOrderAlert = async (order, userEmail) => {
  await transporter.sendMail({
    from: '"MAISON Fashion" <mahalalakshmisidda50@gmail.com>',
    to: 'mahalalakshmisidda50@gmail.com',
...
module.exports = { sendOrderConfirmation, sendOrderDelivered, sendWelcomeEmail, sendAdminOrderAlert };